...
import { Autocomplete, Select, type SelectProps, SelectValue, useFilter } from 'react-aria-components';
        ...
        <Select
            ...
            {list && (
                <>
                    ...
                    <PopoverContent triggerRef={triggerRef} placement='bottom' className='flex w-full flex-col'>
