...
export default function LoginForm({
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        if (!isLoaded && !signIn || !email) return null;
            ...
            <Card className="overflow-hidden p-0">
                <CardContent className="grid p-0 md:grid-cols-2">
                    {verifying ? (
                        ...
                        <Form className="flex flex-col p-6 md:p-8" onSubmit={handleSubmit}>
                            <div className="flex flex-col items-center gap-2 text-center">
                                <h1 className="text-2xl font-bold">Welcome back</h1>
                                <p className="text-muted-foreground text-balance">
                                    Login to your Unlingo account
                                </p>
                            </div>
                            <Field>
                            ...
                            <Field className="items-center">
                                <FieldDescription className="text-center">
                                    Don&apos;t have an account? <Link to="/sign-up/$" className="underline hover:text-accent-foreground">Sign up</Link>
                                </FieldDescription>
                            </Field>
                        </Form>
                    )}
